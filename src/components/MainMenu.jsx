  ...
  return (
    <div className="window-style">
      ...
      <div className="window-content">
        <ButtonOpenSound className='btn-sobre btn-menu' onClick={() => openPopup('Sobre mim', <Sobre/>, 'sobre-style')}><img src={about} alt="Sobre" className='icon-popups icon-sobre'/><p>Sobre</p></ButtonOpenSound>
        <ButtonOpenSound className='btn-projetos btn-menu' onClick={() => openPopup('Projetos', <Projetos/>, 'projetos-style')}><img src={project} alt="Projetos" className='icon-popups icon-projetos'/><p>Projetos</p></ButtonOpenSound>
        <ButtonOpenSound className='btn-links btn-menu' onClick={() => openPopup('Links', <Links/>, 'links-style')}><img src={link} alt="Links" className='icon-popups icon-links'/><p>Links</p></ButtonOpenSound>
        <ButtonOpenSound className='btn-contato btn-menu' onClick={() => openPopup('Contato', <Contato/>, 'contato-style')}><img src={email} alt="Email" className='icon-popups icon-contato'/><p>Contatos</p></ButtonOpenSound>
      </div>
      {popups.map(popup => (
        <DraggablePopup 
          key={popup.id} 
